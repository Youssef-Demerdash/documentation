...
| In the :file:`README` of this `Airproof module <https://github.com/odoo/tutorials/tree/16.0/website_airproof>`_
  , you can find the various Airproof designs that you will replicate throughout the different
