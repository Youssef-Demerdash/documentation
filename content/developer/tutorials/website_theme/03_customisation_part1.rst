.. _tutorials/website_theme/customisation_part1:
...
You will find the various `media here <https://github.com/odoo/tutorials/tree/16.0/website_airproof/static/src/img/content/icons>`_.
...
.. spoiler:: Solutions
   ...
   <https://github.com/odoo/tutorials/tree/16.0/website_airproof/static/src/scss/layout/header.scss>`_ 
   and `caroussel.scss <https://github.com/odoo/tutorials/tree/16.0/website_airproof/static/src/scss/snippets/caroussel.scss>`_.
...
.. spoiler:: Solutions
   ...
   - use `bootstrap_overridden <https://github.com/odoo/tutorials/tree/16.0/website_airproof/static/src/scss/bootstrap_overridden.scss>`_
     like `$navbar-light-color`, `$navbar-light-hover-color`, `$navbar-padding-y`...
   - add some `scss <https://github.com/odoo/tutorials/tree/16.0/website_airproof/static/src/scss/layout/header.scss>`_
     rules.
